...
function fishing(){
 ...
 <section class="fishing-scene" data-fish-scene><div class="ambient-light"></div><div class="cloud-soft cloud-a"></div><div class="cloud-soft cloud-b"></div><div class="water-sheen"></div><div class="butterfly"><i></i><i></i></div><div class="fish fish1"><img src="assets/art/fish-orange.png" alt=""></div><div class="fish fish2 blue"><img src="assets/art/fish-orange.png" alt=""></div><div class="fish fish3 yellow"><img src="assets/art/fish-orange.png" alt=""></div><span class="ripples ripple-one"></span><span class="ripples ripple-two"></span><div class="dock"><i></i><i></i></div><div class="rod ${f.stage}"><i class="reel"></i><i class="handle"></i></div><svg class="line" viewBox="0 0 1000 600" preserveAspectRatio="none"><path d="M585,555 Q625,260 720,392"/></svg>
...
function render(){
 const pages={welcome,activities,fishing,fishingIntro,tutorial,conversation,fishingReport,guidedMoment,memory,explore:()=>experience('explore'),talk:()=>experience('talk'),relax:()=>experience('relax'),listening,pairing,daily:()=>reports(false),weekly:()=>reports(true),family,settings,demo,loading,error};
...
document.addEventListener('click', e=>{
 ...
 const begin=e.target.closest('[data-begin-moment]');if(begin){begin.textContent='This moment has begun';begin.disabled=true;toast('Sunny is right here with you');return;}
